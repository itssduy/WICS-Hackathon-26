    ...
    <div className="auth-page">
      ...
      <div className="auth-brand-panel">
        ...
        <div className="auth-brand-content fade-in-up">
          ...
          <h1 className="auth-brand-title">Give your thoughts a quiet place to land</h1>
          <p className="auth-brand-desc">
            Take a quiet moment for yourself. I Reflect helps you slow down, sit with meaningful thoughts,
      ...
      <div className="auth-form-panel">
        <form className="auth-form glass-card-strong soft-bloom" onSubmit={onSubmit} id="signup-form">
          <div className="auth-form-header">
            <h2>Begin your journey</h2>
            <p>Set up your space for calmer, more intentional reflection.</p>
          </div>
